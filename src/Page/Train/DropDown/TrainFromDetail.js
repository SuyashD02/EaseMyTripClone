...
"Jodhpur Junction",
  ...
  return (
    <div className="w-[20em] h-55 ml-[3em] absolute bg-slate-50 mt-10 p-2 rounded shadow-[0_8px_30px_rgb(0,0,0,0.12)] z-10">
      <input
...
export default TrainFromDetail